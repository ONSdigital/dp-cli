...
var libraryFiles = []fileGen{
	{
		templatePath: "library/go/.golangci.yml",
		outputPath:   ".golangci",
		extension:    ".yml",
		filePrefix:   "",
	},
	{
		templatePath: "library/go/ci/build.yml",
		outputPath:   "ci/build",
		extension:    ".yml",
		filePrefix:   "",
	},
	{
		templatePath: "library/go/ci/unit.yml",
		outputPath:   "ci/unit",
		extension:    ".yml",
		filePrefix:   "",
	},
	{
		templatePath: "library/go/ci/audit.yml",
		outputPath:   "ci/audit",
		extension:    ".yml",
		filePrefix:   "",
	},
	{
		templatePath: "library/go/ci/lint.yml",
		outputPath:   "ci/lint",
		extension:    ".yml",
		filePrefix:   "",
	},
	{
		templatePath: "library/go/ci/scripts/build.sh",
		outputPath:   "ci/scripts/build",
		extension:    ".sh",
		filePrefix:   "",
		executable:   true,
	...
	{
		templatePath: "library/go/ci/scripts/unit.sh",
		outputPath:   "ci/scripts/unit",
		extension:    ".sh",
		filePrefix:   "",
		executable:   true,
	...
	{
		templatePath: "library/go/ci/scripts/audit.sh",
		outputPath:   "ci/scripts/audit",
		extension:    ".sh",
		filePrefix:   "",
		executable:   true,
	...
	{
		templatePath: "library/go/ci/scripts/lint.sh",
		outputPath:   "ci/scripts/lint",
		extension:    ".sh",
		filePrefix:   "",
		executable:   true,
